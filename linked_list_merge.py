...
def merge(left: LinkedList, right: LinkedList) -> LinkedList:
    """
    Merges two linked list, sortig by data in nodes
    ...
    while left_head or right_head:
        ...
        # If the head node of left is None, we are going to past the tail
        ...
        # If the head node of the right is None, we are past the tail
    ...
    # discar fake head and set first merge node as head
...
print(l)
sorted_linke_list = merge_sort(l)
print(sorted_linke_list)